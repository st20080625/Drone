...
void loop()
{
  ...
  motor_speed = offset_motor_speed + map(Ly,-128, 127, -offset_motor_speed, 100-offset_motor_speed);
  ...
  motor_value0 = constrain(motor_value0, 0.0, 1000.0);
  motor_value1 = constrain(motor_value1, 0.0, 1000.0);
  motor_value2 = constrain(motor_value2, 0.0, 1000.0);
  motor_value3 = constrain(motor_value3, 0.0, 1000.0);
